...
function translate(x, y) {
  if (this._vs_node_tx === x && this._vs_node_ty === y) {
    return;
  }
...
function getCTM() {
  ...
  if (this._vs_transform) return matrix.multiply(this._vs_transform);else return matrix;
};
