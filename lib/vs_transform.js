define(['vs_utils'], function (utils) { 'use strict';

var utils__default = 'default' in utils ? utils['default'] : utils;
...
//    if (!util.isNumber (origin.x) || !util.isNumber (origin.y)) { return; }
  ...
  var matrix = new utils.CSSMatrix ();
...
function getCTM ()
{
  var matrix = new utils.CSSMatrix (), transform, matrix_tmp;
  if (!this._vs_node_origin) this._vs_node_origin = [0, 0];
...
function getParentCTM ()
{
  ...
  function multiplyParentTCM (parent)
  {
    ...
    if (!parent) return new utils.CSSMatrix ();
...
function applyTransformation (node)
{
  ...
  utils__default.setElementTransform (node, matrix.toString ());
}

utils__default.extend (HTMLElement.prototype, {
  _vs_node_tx:                  0,
  _vs_node_ty:                  0,
  _vs_node_s:              1,
  _vs_node_r:             0,
